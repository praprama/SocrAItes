...
initialize()
client = OpenAI()
socraites_agent = OpenAIAssistantRunnable(assistant_id=os.getenv('SOCRAITES_SUGGESTIVE'), tools=rag_tools, as_agent=True)
...
def socrates():
    ...
    st.markdown("# Hi. I am the conversational SocrAItes. How can I help you?")
