...
You should not provide the notes to the learner. Your job is only to guide the learner in the process of filling up the notes by coming up with the questions. The total number of questions should not exceed 5 in all to help fill the entire set of notes.
